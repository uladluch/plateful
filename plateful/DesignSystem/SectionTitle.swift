...
///
/// Headline 3, полужирным, основным цветом текста — вместо мелкого системного
...
struct SectionTitle: View {
    ...
    var body: some View {
        Text(title)
            .font(.title3)
            // Полужирный, а не жирный: жирный title3 почти равнялся шапке
            // экрана (title2 полужирным), и «экран → раздел» не читалось.
            .fontWeight(.semibold)
