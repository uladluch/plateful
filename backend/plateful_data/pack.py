...
# процентов.
#
# Пороги разные, и по делу. **Свежесть — девять десятых**: устаревшая
# цифра врёт молча, человек считает по ней и не догадывается, что она
# пятилетняя. **Снимки — семь десятых**: карточка без фотографии не врёт,
# она просто беднее, и цена ошибки тут другая. Держать снимки на том же
# уровне значило бы прятать сеть с верными цифрами из-за трёх десятков
# ненайденных фотографий — а человеку нужна сеть, а не её отсутствие.
#
